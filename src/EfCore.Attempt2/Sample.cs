...
namespace EfCore.Attempt2
{
    public class Sample2
    {
        ...
        {
            Log.Information("Starting attempt 2...");
            CreateAndSeed();
        ...
        static StudentDbContext GetDbContext()
        {
            ...
            optionsBuilder.UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=EnumsAttempt2;Trusted_Connection=True;");
